...
public class MainActivity extends AppCompatActivity {
    ///// sleepTimer를 위해 추가한 부분 /////
    Intent backStartIntent;
    TextView tv_sleepTimer;
    Button btn_sleepTimer;
    ///// sleepTimer를 위해 추가한 부분 /////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backStartIntent = new Intent(MainActivity.this, SleepTimer.class);
        ...
        tv_sleepTimer = findViewById(R.id.tv_sleepTimer);
        btn_sleepTimer = findViewById(R.id.btn_sleepTimer);

        btn_sleepTimer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sleepTIme, values, sleepCount;
                sleepTIme = "잔시간 " + SingletonSleepTimerValue.getInstance().getGapSleepTime() + "\n";
                values = "Lux : " + SingletonSleepTimerValue.getInstance().getMaxLuxValue() + "  shake : " + SingletonSleepTimerValue.getInstance().getShakeCounter() + "\n";
                sleepCount = "count " + SingletonSleepTimerValue.getInstance().getSleepCounter();

                tv_sleepTimer.setText(sleepTIme + values + sleepCount);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent state_Intent = new Intent(MainActivity.this, state_check.class);
