...
public class HealthCare extends AppCompatActivity {
    ...
    private TextView tv_startsleep;
...
/*
        String timeprinter = "";
        timeprinter = transTime( SingletonSleepTimerValue.getInstance().getStartSleepTIme() );
        tv_startsleep.setText( timeprinter );
        timeprinter = transTime( SingletonSleepTimerValue.getInstance().getFinishSleepTime() );
        tv_endsleep.setText( timeprinter );*/
